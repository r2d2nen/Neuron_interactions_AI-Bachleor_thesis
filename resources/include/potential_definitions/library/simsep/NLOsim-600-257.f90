...
!   CMD: ./make_chp_init_code NLOsim-600-257.ini +potential_name=NLOsim_257
...
subroutine chp_preset_NLOsim_257
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.130590796076552D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.078928190325764D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.121216704141638D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.078928190325764D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.125755435071781D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.078928190325764D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.558284979395430D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.492541388614240D0) ! C_3P0
    call chp_set_NLO_contact(3,    1.559220570115420D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.291062431333609D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.350343986295557D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.434874493705530D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.154152916531215D0) ! C_3P2
