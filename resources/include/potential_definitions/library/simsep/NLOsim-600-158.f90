...
!   CMD: ./make_chp_init_code NLOsim-600-158.ini +potential_name=NLOsim_158
...
subroutine chp_preset_NLOsim_158
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.197595497997078D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.097602129561925D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.186720334824239D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.097602129561925D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.191984281392176D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.097602129561925D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.703260004445900D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.512970130547320D0) ! C_3P0
    call chp_set_NLO_contact(3,    1.800086214305760D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.342577393037608D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.115967796512064D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.248391868245486D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.165108493516709D0) ! C_3P2
