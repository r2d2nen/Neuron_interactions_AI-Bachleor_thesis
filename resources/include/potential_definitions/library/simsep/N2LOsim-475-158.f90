...
!   CMD: ./make_chp_init_code N2LOsim-475-158.ini +potential_name=N2LOsim_158

! SUITABLE V3 parameters:
!   c_D:   -0.003483287559090D0
!   c_E:   -0.301433287933233D0
...
subroutine chp_preset_N2LOsim_158
    ...
    call chp_set_c1(  -0.490848045015910D0)
    call chp_set_c3(  -3.784578931736340D0)
    call chp_set_c4(   2.848878540066380D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.149988583713959D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.172230563309773D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.150711863599438D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.172230563309773D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.150596687668817D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.172230563309773D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.463757229635950D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.139039038827050D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.299418977281990D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.913420721941639D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.638045001862131D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.443070290562439D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.699936022596813D0) ! C_3P2
