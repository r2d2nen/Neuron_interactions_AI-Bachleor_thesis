...
!   CMD: ./make_chp_init_code LOsim-525-257.ini +potential_name=LOsim_257
...
subroutine chp_preset_LOsim_257
    ...
    call chp_set_LO_contact(1,   -0.105769820737174D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.062831756834820D0) ! Ct_3S1
