...
!   CMD: ./make_chp_init_code LOsim-575-125.ini +potential_name=LOsim_125
...
subroutine chp_preset_LOsim_125
    ...
    call chp_set_LO_contact(1,   -0.102443656014029D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.044859641430204D0) ! Ct_3S1
