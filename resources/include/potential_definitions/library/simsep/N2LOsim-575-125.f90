...
!   CMD: ./make_chp_init_code N2LOsim-575-125.ini +potential_name=N2LOsim_125

! SUITABLE V3 parameters:
!   c_D:    0.693667175158311D0
!   c_E:   -1.231804538090270D0
...
subroutine chp_preset_N2LOsim_125
    ...
    call chp_set_c1(  -0.489719938069039D0)
    call chp_set_c3(  -4.034664284028480D0)
    call chp_set_c4(   2.247064389500770D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.148687764648685D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.141257469181027D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149452327588162D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.141257469181027D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149787833321461D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.141257469181027D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.474780278169580D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.426083764413390D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.127269090117279D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.597889697041200D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.533694025789303D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.279514698066624D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.735260100235264D0) ! C_3P2
