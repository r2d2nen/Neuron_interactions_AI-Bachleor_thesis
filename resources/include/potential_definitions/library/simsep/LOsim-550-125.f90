...
!   CMD: ./make_chp_init_code LOsim-550-125.ini +potential_name=LOsim_125
...
subroutine chp_preset_LOsim_125
    ...
    call chp_set_LO_contact(1,   -0.104030073478724D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.053886490341880D0) ! Ct_3S1
