...
!   CMD: ./make_chp_init_code N2LOsim-525-158.ini +potential_name=N2LOsim_158

! SUITABLE V3 parameters:
!   c_D:    0.213041967003233D0
!   c_E:   -0.461704692925466D0
...
subroutine chp_preset_N2LOsim_158
    ...
    call chp_set_c1(  -0.418721357554595D0)
    call chp_set_c3(  -3.721912818126470D0)
    call chp_set_c4(   2.649551805870170D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.149178015226913D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.161635015505316D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149918621208234D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.161635015505316D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149961168766286D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.161635015505316D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.441464628886930D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.219177056674630D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.272698208595508D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.843606992406086D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.570350703896861D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.399349535327386D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.688209074317154D0) ! C_3P2
