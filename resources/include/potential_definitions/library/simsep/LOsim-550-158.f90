...
!   CMD: ./make_chp_init_code LOsim-550-158.ini +potential_name=LOsim_158
...
subroutine chp_preset_LOsim_158
    ...
    call chp_set_LO_contact(1,   -0.104030274750854D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.053886499658229D0) ! Ct_3S1
