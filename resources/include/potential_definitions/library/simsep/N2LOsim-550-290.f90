...
!   CMD: ./make_chp_init_code N2LOsim-550-290.ini +potential_name=N2LOsim_290

! SUITABLE V3 parameters:
!   c_D:    0.000006704198358D0
!   c_E:   -0.672759579305671D0
...
subroutine chp_preset_N2LOsim_290
    ...
    call chp_set_c1(   0.272376549025164D0)
    call chp_set_c3(  -3.564141721708020D0)
    call chp_set_c4(   3.644063745628490D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.145517908944609D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.160087921395969D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.146429498290910D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.160087921395969D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.146348534053797D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.160087921395969D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.532881353083160D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.202972866614650D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.446746745129390D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.889764996202419D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.651997784793201D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.550066339576639D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.657707830675521D0) ! C_3P2
