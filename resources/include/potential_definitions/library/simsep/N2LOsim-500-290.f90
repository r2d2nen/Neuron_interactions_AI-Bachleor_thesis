...
!   CMD: ./make_chp_init_code N2LOsim-500-290.ini +potential_name=N2LOsim_290

! SUITABLE V3 parameters:
!   c_D:   -0.324635160802756D0
!   c_E:   -0.521434299320049D0
...
subroutine chp_preset_N2LOsim_290
    ...
    call chp_set_c1(   0.223309589869521D0)
    call chp_set_c3(  -3.555370966483840D0)
    call chp_set_c4(   3.932955198758110D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.146528346023470D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.168682343049066D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.147357270271591D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.168682343049066D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.147133410325357D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.168682343049066D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.547591022694240D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.160637555142880D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.519681149764964D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.955290833468129D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.704775975054180D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.597277423826393D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.657500211186166D0) ! C_3P2
