...
!   CMD: ./make_chp_init_code LOsim-575-290.ini +potential_name=LOsim_290
...
subroutine chp_preset_LOsim_290
    ...
    call chp_set_LO_contact(1,   -0.102444570710459D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.044859713923778D0) ! Ct_3S1
