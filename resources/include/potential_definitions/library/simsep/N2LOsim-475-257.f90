...
!   CMD: ./make_chp_init_code N2LOsim-475-257.ini +potential_name=N2LOsim_257

! SUITABLE V3 parameters:
!   c_D:   -0.391014661818084D0
!   c_E:   -0.475319135500221D0
...
subroutine chp_preset_N2LOsim_257
    ...
    call chp_set_c1(  -0.013847077797546D0)
    call chp_set_c3(  -3.544098412987780D0)
    call chp_set_c4(   3.876602507540300D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.148092597237786D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.174567977209414D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148886544622665D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.174567977209414D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.148631667429984D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.174567977209414D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.523703186012430D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.162361852203570D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.539756840474366D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.953974123557512D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.706943562933437D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.599258733225425D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.656155409754791D0) ! C_3P2
