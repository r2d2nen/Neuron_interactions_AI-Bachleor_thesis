...
!   CMD: ./make_chp_init_code LOsep-500-290.ini +potential_name=LOsep_500_290

subroutine chp_preset_LOsep_500_290
    ...
    call chp_set_LO_contact(1,   -0.107684069666499D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.071718270485921D0) ! Ct_3S1
