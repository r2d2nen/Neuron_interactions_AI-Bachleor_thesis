...
!   CMD: ./make_chp_init_code LOsim-600-290.ini +potential_name=LOsim_290
...
subroutine chp_preset_LOsim_290
    ...
    call chp_set_LO_contact(1,   -0.100991324595172D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.035637628703518D0) ! Ct_3S1
