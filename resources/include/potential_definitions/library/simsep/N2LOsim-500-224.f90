...
!   CMD: ./make_chp_init_code N2LOsim-500-224.ini +potential_name=N2LOsim_224

! SUITABLE V3 parameters:
!   c_D:   -0.188759424839954D0
!   c_E:   -0.460407151681190D0
...
subroutine chp_preset_N2LOsim_224
    ...
    call chp_set_c1(  -0.067642302771613D0)
    call chp_set_c3(  -3.583577726334540D0)
    call chp_set_c4(   3.526755473484180D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.147964441139531D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.169100492816035D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148755546883078D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.169100492816035D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.148590140933334D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.169100492816035D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.502276548649250D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.168743874124710D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.444941826061014D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.923373267422842D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.659626161507624D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.542127892088550D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.662621197542921D0) ! C_3P2
