...
!   CMD: ./make_chp_init_code N2LOsim-525-125.ini +potential_name=N2LOsim_125

! SUITABLE V3 parameters:
!   c_D:    0.507704867818722D0
!   c_E:   -0.472622318435323D0
...
subroutine chp_preset_N2LOsim_125
    ...
    call chp_set_c1(  -0.593315977856843D0)
    call chp_set_c3(  -4.166424413194500D0)
    call chp_set_c4(   2.059492089296300D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.149522286623500D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.153995348283990D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.150241191016099D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.153995348283990D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.150387605521586D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.153995348283990D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.483794727602420D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.175758086673430D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.086578348981080D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.758823919828238D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.581196305638612D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.282568936616841D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.760190232774898D0) ! C_3P2
