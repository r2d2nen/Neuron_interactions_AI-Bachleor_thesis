...
!   CMD: ./make_chp_init_code N2LOsim-575-257.ini +potential_name=N2LOsim_257

! SUITABLE V3 parameters:
!   c_D:    0.208295299701706D0
!   c_E:   -0.886859018101325D0
...
subroutine chp_preset_N2LOsim_257
    ...
    call chp_set_c1(   0.041579448852633D0)
    call chp_set_c3(  -3.505388374356840D0)
    call chp_set_c4(   3.362886330152140D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.146429066880884D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.157941209080800D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.147375961665245D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.157941209080800D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.147409007544811D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.157941209080800D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.484709934892930D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.283989499755290D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.420837995250517D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.803665324317899D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.594423482066910D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.513461875514938D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.644890898438971D0) ! C_3P2
