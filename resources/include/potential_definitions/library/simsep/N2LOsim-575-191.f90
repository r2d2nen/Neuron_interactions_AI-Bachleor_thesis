...
!   CMD: ./make_chp_init_code N2LOsim-575-191.ini +potential_name=N2LOsim_191

! SUITABLE V3 parameters:
!   c_D:    0.438397253769489D0
!   c_E:   -0.955345291790695D0
...
subroutine chp_preset_N2LOsim_191
    ...
    call chp_set_c1(  -0.270706763412610D0)
    call chp_set_c3(  -3.685897750743210D0)
    call chp_set_c4(   2.692760657013790D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.147757842097331D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.153888436979551D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148582173677198D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.153888436979551D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.148769012530127D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.153888436979551D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.445989817096860D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.386013950848610D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.285687166981678D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.762181639586089D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.546132637268319D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.403668002111567D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.679687774989766D0) ! C_3P2
