...
!   CMD: ./make_chp_init_code N2LOsim-500-257.ini +potential_name=N2LOsim_257

! SUITABLE V3 parameters:
!   c_D:   -0.256164779226717D0
!   c_E:   -0.489951364860195D0
...
subroutine chp_preset_N2LOsim_257
    ...
    call chp_set_c1(   0.067598877779116D0)
    call chp_set_c3(  -3.566427709171800D0)
    call chp_set_c4(   3.726739885744590D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.147324693778036D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.169269463065157D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148136434549227D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.169269463065157D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.147939945521210D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.169269463065157D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.523792756702290D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.164131027314740D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.486623004950485D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.936140418039621D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.682437909303781D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.571592879099511D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.659485472475834D0) ! C_3P2
