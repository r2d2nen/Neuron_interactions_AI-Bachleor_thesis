...
!   CMD: ./make_chp_init_code LOsim-500-158.ini +potential_name=LOsim_158
...
subroutine chp_preset_LOsim_158
    ...
    call chp_set_LO_contact(1,   -0.107683603448135D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.071808595918794D0) ! Ct_3S1
