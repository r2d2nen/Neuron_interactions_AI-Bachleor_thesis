...
!   CMD: ./make_chp_init_code LOsim-450-158.ini +potential_name=LOsim_158
...
subroutine chp_preset_LOsim_158
    ...
    call chp_set_LO_contact(1,   -0.112157119223374D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.090342098757737D0) ! Ct_3S1
