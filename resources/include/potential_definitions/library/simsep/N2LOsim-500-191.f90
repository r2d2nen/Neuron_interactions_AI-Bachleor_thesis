...
!   CMD: ./make_chp_init_code N2LOsim-500-191.ini +potential_name=N2LOsim_191

! SUITABLE V3 parameters:
!   c_D:    0.091092232936417D0
!   c_E:   -0.362277503718894D0
...
subroutine chp_preset_N2LOsim_191
    ...
    call chp_set_c1(  -0.359748272925036D0)
    call chp_set_c3(  -3.775583122554220D0)
    call chp_set_c4(   2.777444200394520D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.148991027603193D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.167345401238915D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149726438965865D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.167345401238915D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149666957112290D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.167345401238915D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.465011076359960D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.160877467665150D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.294417546256292D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.899940689545979D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.615095325350255D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.435792880207045D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.699135322199911D0) ! C_3P2
