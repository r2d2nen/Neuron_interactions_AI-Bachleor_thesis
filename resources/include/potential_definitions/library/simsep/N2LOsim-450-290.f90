...
!   CMD: ./make_chp_init_code N2LOsim-450-290.ini +potential_name=N2LOsim_290

! SUITABLE V3 parameters:
!   c_D:   -0.594369568767894D0
!   c_E:   -0.528392824205448D0
...
subroutine chp_preset_N2LOsim_290
    ...
    call chp_set_c1(  -0.049945208963073D0)
    call chp_set_c3(  -3.447359055205400D0)
    call chp_set_c4(   4.235271764429980D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.148808247594741D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.180749800738380D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149609495633539D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.180749800738380D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149282922543376D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.180749800738380D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.526818837010760D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.183327435692520D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.663503245265533D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.966551394140239D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.739620354836631D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.657417216397392D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.639310422974529D0) ! C_3P2
