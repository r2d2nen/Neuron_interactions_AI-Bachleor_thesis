...
!   CMD: ./make_chp_init_code NLOsim-600-290.ini +potential_name=NLOsim_290
...
subroutine chp_preset_NLOsim_290
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.108938554836599D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.074866471374221D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.100073051789240D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.074866471374221D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.104363617957195D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.074866471374221D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.507655590430840D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.485839048775780D0) ! C_3P0
    call chp_set_NLO_contact(3,    1.557588872482270D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.288961445968120D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.382510460080482D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.462082024614664D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.152116985646247D0) ! C_3P2
