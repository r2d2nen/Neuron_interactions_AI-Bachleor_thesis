...
!   CMD: ./make_chp_init_code N2LOsim-450-257.ini +potential_name=N2LOsim_257

! SUITABLE V3 parameters:
!   c_D:   -0.507650497426143D0
!   c_E:   -0.482696194714095D0

subroutine chp_preset_N2LOsim_257
    ...
    call chp_set_c1(  -0.132606544698476D0)
    call chp_set_c3(  -3.510827024501770D0)
    call chp_set_c4(   4.021824331510660D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.149082613365112D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.180583380494583D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149874677746993D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.180583380494583D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149568121207924D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.180583380494583D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.518276776757700D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.171257318930540D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.610035793520829D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.961389964835343D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.730385452156603D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.628789556241625D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.651476825118972D0) ! C_3P2
