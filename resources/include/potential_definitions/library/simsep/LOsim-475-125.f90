...
!   CMD: ./make_chp_init_code LOsim-475-125.ini +potential_name=LOsim_125

subroutine chp_preset_LOsim_125
    ...
    call chp_set_LO_contact(1,   -0.109801256456291D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.080935420509248D0) ! Ct_3S1
