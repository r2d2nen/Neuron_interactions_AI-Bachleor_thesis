...
!   CMD: ./make_chp_init_code NLOsep-500-290-mp.ini +potential_name=NLOsep_500_290_mp

subroutine chp_preset_NLOsep_500_290_mp
    ...
    call chp_set_CIB_LO_contact(1, -1,   -0.148917926236282D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,    0.683585558166011D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.150579639832714D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,    0.683585558166011D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149913410620251D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,    0.683585558166011D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    1.693199532750440D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.308084982483270D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.868253475941196D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.338983077325235D0) ! C_3P1
    call chp_set_NLO_contact(5,   -3.887241253246230D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.314513548894695D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.200820057206790D0) ! C_3P2
