...
!   CMD: ./make_chp_init_code N2LOsim-600-257.ini +potential_name=N2LOsim_257

! SUITABLE V3 parameters:
!   c_D:    0.387842737425589D0
!   c_E:   -1.382816357452390D0
...
subroutine chp_preset_N2LOsim_257
    ...
    call chp_set_c1(  -0.044006289893830D0)
    call chp_set_c3(  -3.448138286326810D0)
    call chp_set_c4(   3.273646380814100D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.146430800289907D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.155399891454467D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.147448921762864D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.155399891454467D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.147577762272595D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.155399891454467D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.461029925957680D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.381846354471480D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.422642574015614D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.725394798184013D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.562579895742128D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.502376528753636D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.632381806535838D0) ! C_3P2
