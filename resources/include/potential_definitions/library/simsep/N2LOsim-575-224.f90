...
!   CMD: ./make_chp_init_code N2LOsim-575-224.ini +potential_name=N2LOsim_224

! SUITABLE V3 parameters:
!   c_D:    0.251411101574857D0
!   c_E:   -0.887049713710352D0
...
subroutine chp_preset_N2LOsim_224
    ...
    call chp_set_c1(  -0.101008674233407D0)
    call chp_set_c3(  -3.502947735588540D0)
    call chp_set_c4(   3.188155315186470D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.147211026017042D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.157540964047763D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148133305123016D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.157540964047763D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.148196743205408D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.157540964047763D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.460956162935570D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.308377779339820D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.395864999865636D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.782941166581631D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.567899969683466D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.486235846963358D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.644517227003105D0) ! C_3P2
