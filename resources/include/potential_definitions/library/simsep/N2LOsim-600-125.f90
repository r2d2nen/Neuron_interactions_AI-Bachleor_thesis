...
!   CMD: ./make_chp_init_code N2LOsim-600-125.ini +potential_name=N2LOsim_125

! SUITABLE V3 parameters:
!   c_D:    0.834837017216031D0
!   c_E:   -2.401933385841360D0
...
subroutine chp_preset_N2LOsim_125
    ...
    call chp_set_c1(  -0.455192391633801D0)
    call chp_set_c3(  -3.972725416859660D0)
    call chp_set_c4(   2.334924194366340D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.148298474504224D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.134847463539466D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149099981124624D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.134847463539466D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149536798748395D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.134847463539466D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.469282510535030D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.634315809383780D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.149378392971323D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.472383574994683D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.512457501192277D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.279205459137258D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.723248729992307D0) ! C_3P2
