...
!   CMD: ./make_chp_init_code N2LOsim-450-191.ini +potential_name=N2LOsim_191

! SUITABLE V3 parameters:
!   c_D:   -0.089067922887361D0
!   c_E:   -0.275535257004520D0
...
subroutine chp_preset_N2LOsim_191
    ...
    call chp_set_c1(  -0.498688766748972D0)
    call chp_set_c3(  -3.816862034065770D0)
    call chp_set_c4(   2.947901157575500D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.150217954032319D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.178503073740344D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.150965175678792D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.178503073740344D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.150763652340158D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.178503073740344D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.476537662666410D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.110831432083700D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.354945812544124D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.943280476205825D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.677256237635017D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.477839886862872D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.708093724695541D0) ! C_3P2
