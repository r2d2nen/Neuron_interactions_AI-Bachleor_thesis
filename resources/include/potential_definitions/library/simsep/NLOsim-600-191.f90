...
!   CMD: ./make_chp_init_code NLOsim-600-191.ini +potential_name=NLOsim_191
...
subroutine chp_preset_NLOsim_191
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.147839560977578D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.096983673468947D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.138109660812066D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.096983673468947D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.142800377248701D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.096983673468947D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.597180689087060D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.530820949551260D0) ! C_3P0
    call chp_set_NLO_contact(3,    1.745117143008660D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.357578310933728D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.158025114999165D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.288234311274180D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.162789496228471D0) ! C_3P2
