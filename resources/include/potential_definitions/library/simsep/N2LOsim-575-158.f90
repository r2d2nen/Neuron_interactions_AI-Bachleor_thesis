...
!   CMD: ./make_chp_init_code N2LOsim-575-158.ini +potential_name=N2LOsim_158

! SUITABLE V3 parameters:
!   c_D:    0.472488620373193D0
!   c_E:   -0.989841092031393D0
...
subroutine chp_preset_N2LOsim_158
    ...
    call chp_set_c1(  -0.370138875204641D0)
    call chp_set_c3(  -3.661343427528740D0)
    call chp_set_c4(   2.566625945629500D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.148341628267143D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.152173385669016D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149154016834283D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.152173385669016D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149373659886413D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.152173385669016D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.425990966313700D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.397479502092260D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.281706544139449D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.734252174922509D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.522456276574205D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.374880313780023D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.676008919546528D0) ! C_3P2
