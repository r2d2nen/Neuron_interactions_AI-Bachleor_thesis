...
!   CMD: /net/home/borisc/cheft/master/make_chp_init_code NNLOsim_290.ini +potential_name=NNLOsim_290

! SUITABLE V3 parameters:
!   c_D:   -0.324454678210943D0
!   c_E:   -0.520920162607190D0

subroutine chp_preset_NNLOsim_290
    ...
    call chp_set_c1(   0.223841596775856D0)
    call chp_set_c3(  -3.555406802969360D0)
    call chp_set_c4(   3.933451147062290D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.146525827514611D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.168718941891471D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.147355583336988D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.168718941891471D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.147117838042339D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.168718941891471D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.547683766858780D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.160497075038310D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.520011536493719D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.955365086625806D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.705217297418910D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.597481847610272D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.657504189537127D0) ! C_3P2
