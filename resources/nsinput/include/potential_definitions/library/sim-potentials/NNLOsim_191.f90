...
!   CMD: /net/home/borisc/cheft/master/make_chp_init_code NNLOsim_191.ini +potential_name=NNLOsim_191

! SUITABLE V3 parameters:
!   c_D:    0.087411873717645D0
!   c_E:   -0.362918237324429D0

subroutine chp_preset_NNLOsim_191
    ...
    call chp_set_c1(  -0.372387042726534D0)
    call chp_set_c3(  -3.760276700802260D0)
    call chp_set_c4(   2.775529623028040D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.149079512196582D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.168148229682302D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149814400371217D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.168148229682302D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149756181718774D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.168148229682302D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.460638969935570D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.162689570606800D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.301977615323358D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.898730849916435D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.614075652883725D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.440911556461823D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.696442513088953D0) ! C_3P2
