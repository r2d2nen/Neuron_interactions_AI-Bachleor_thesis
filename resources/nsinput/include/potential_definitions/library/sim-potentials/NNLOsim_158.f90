...
!   CMD: /net/home/borisc/cheft/master/make_chp_init_code NNLOsim_158.ini +potential_name=NNLOsim_158

! SUITABLE V3 parameters:
!   c_D:    0.086125105400387D0
!   c_E:   -0.361621050393797D0

subroutine chp_preset_NNLOsim_158
    ...
    call chp_set_c1(  -0.408870214227683D0)
    call chp_set_c3(  -3.733429503450070D0)
    call chp_set_c4(   2.753060104148950D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.149323559549561D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.168464810193961D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.150057642471680D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.168464810193961D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.150000605586014D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.168464810193961D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.450955414428870D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.167471146141150D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.296103390928662D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.890680397310234D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.604950565750669D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.438796541261467D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.691878808760559D0) ! C_3P2
