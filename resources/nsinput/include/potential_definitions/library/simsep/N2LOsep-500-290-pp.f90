...
!   CMD: ./make_chp_init_code N2LOsep-500-290-pp.ini +potential_name=N2LOsep_500_290_pp

! SUITABLE V3 parameters:
!   c_D:   -1.333936499173860D0
!   c_E:    5.139416596375900D0

subroutine chp_preset_N2LOsep_500_290_pp
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.491403399784891D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,    0.530201168789487D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.489503886259262D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,    0.530201168789487D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.492339817439214D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,    0.530201168789487D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    0.279144399388818D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.286982532631710D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.554723872764063D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.972752155763746D0) ! C_3P1
    call chp_set_NLO_contact(5,   -1.845153214784280D0) ! C_3S1
    call chp_set_NLO_contact(6,    1.111036887793300D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.685831714382663D0) ! C_3P2
