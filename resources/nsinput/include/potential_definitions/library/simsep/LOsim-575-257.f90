...
!   CMD: ./make_chp_init_code LOsim-575-257.ini +potential_name=LOsim_257
...
subroutine chp_preset_LOsim_257
    ...
    call chp_set_LO_contact(1,   -0.102444397973146D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.044859699523660D0) ! Ct_3S1
