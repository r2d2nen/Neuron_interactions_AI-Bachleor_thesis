...
!   CMD: ./make_chp_init_code N2LOsim-550-224.ini +potential_name=N2LOsim_224

! SUITABLE V3 parameters:
!   c_D:    0.094157481760202D0
!   c_E:   -0.644680793837848D0
...
subroutine chp_preset_N2LOsim_224
    ...
    call chp_set_c1(  -0.057964655825611D0)
    call chp_set_c3(  -3.544096629791210D0)
    call chp_set_c4(   3.281070726389870D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.147337706697771D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.160798369260671D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148202918381794D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.160798369260671D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.148181173137125D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.160798369260671D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.478492818716100D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.237481157378130D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.400416325172216D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.843691024420990D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.598397268660804D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.500435658126906D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.653524679277040D0) ! C_3P2
