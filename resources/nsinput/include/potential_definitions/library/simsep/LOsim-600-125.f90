...
!   CMD: ./make_chp_init_code LOsim-600-125.ini +potential_name=LOsim_125
...
subroutine chp_preset_LOsim_125
    ...
    call chp_set_LO_contact(1,   -0.100990484164182D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.035637531889296D0) ! Ct_3S1
