...
!   CMD: ./make_chp_init_code N2LOsim-600-224.ini +potential_name=N2LOsim_224

! SUITABLE V3 parameters:
!   c_D:    0.424006357863524D0
!   c_E:   -1.408885051434150D0
...
subroutine chp_preset_N2LOsim_224
    ...
    call chp_set_c1(  -0.169426582495726D0)
    call chp_set_c3(  -3.450689569279490D0)
    call chp_set_c4(   3.111755920798860D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.147134351685403D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.154732169866902D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148126932601196D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.154732169866902D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.148283602102160D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.154732169866902D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.440512069144800D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.415893002291940D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.400491844414732D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.703060453409225D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.538366608801277D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.476002271438658D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.633109007919670D0) ! C_3P2
