...
!   CMD: ./make_chp_init_code N2LOsim-575-290.ini +potential_name=N2LOsim_290

! SUITABLE V3 parameters:
!   c_D:    0.175754646768338D0
!   c_E:   -0.892596976839067D0
...
subroutine chp_preset_N2LOsim_290
    ...
    call chp_set_c1(   0.211023156824834D0)
    call chp_set_c3(  -3.524442321519420D0)
    call chp_set_c4(   3.522994299186150D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.145446589815930D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.157053975738505D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.146418352166040D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.157053975738505D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.146426295047657D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.157053975738505D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.512173924703180D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.260368294897020D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.433496342832036D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.832659338825891D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.618558703241287D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.533032949464659D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.648852757362398D0) ! C_3P2
