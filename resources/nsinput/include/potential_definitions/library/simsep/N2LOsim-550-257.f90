...
!   CMD: ./make_chp_init_code N2LOsim-550-257.ini +potential_name=N2LOsim_257

! SUITABLE V3 parameters:
!   c_D:    0.043122074743758D0
!   c_E:   -0.657656725435796D0
...
subroutine chp_preset_N2LOsim_257
    ...
    call chp_set_c1(   0.093212410286500D0)
    call chp_set_c3(  -3.546632474221550D0)
    call chp_set_c4(   3.467358317909980D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.146531962600789D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.161015209429261D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.147420812320060D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.161015209429261D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.147367093027316D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.161015209429261D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.503832231021060D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.220298798305940D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.429405219228351D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.862724887193475D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.625810691146173D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.528554598240846D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.654009052277773D0) ! C_3P2
