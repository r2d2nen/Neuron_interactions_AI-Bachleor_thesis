...
!   CMD: ./make_chp_init_code N2LOsim-475-125.ini +potential_name=N2LOsim_125

! SUITABLE V3 parameters:
!   c_D:    0.403960740267913D0
!   c_E:   -0.174571784713089D0
...
subroutine chp_preset_N2LOsim_125
    ...
    call chp_set_c1(  -0.745952979177697D0)
    call chp_set_c3(  -4.298989844312680D0)
    call chp_set_c4(   1.912695187055720D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.150552962126556D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.167288566824705D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.151272349676067D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.167288566824705D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.151248712013019D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.167288566824705D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.491837739751320D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.035529369146580D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.061834924973739D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.856777822164592D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.639318908556036D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.296679880486171D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.783937958954011D0) ! C_3P2
