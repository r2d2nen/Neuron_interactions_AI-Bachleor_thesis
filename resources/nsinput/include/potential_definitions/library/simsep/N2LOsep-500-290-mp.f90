...
!   CMD: ./make_chp_init_code N2LOsep-500-290-mp.ini +potential_name=N2LOsep_500_290_mp

! SUITABLE V3 parameters:
!   c_D:   16.153534179300500D0
!   c_E:    6.831816457959670D0

subroutine chp_preset_N2LOsep_500_290_mp
    ...
    call chp_set_CIB_LO_contact(1, -1,   -0.152928488648680D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,    0.532537212096873D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.153819840129659D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,    0.532537212096873D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.152558046508932D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,    0.532537212096873D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.744007340977640D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.276656696317480D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.524624965319699D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.938089173798888D0) ! C_3P1
    call chp_set_NLO_contact(5,   -1.844357551867420D0) ! C_3S1
    call chp_set_NLO_contact(6,    1.131477579082950D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.686005458757655D0) ! C_3P2
