...
!   CMD: ./make_chp_init_code N2LOsim-500-125.ini +potential_name=N2LOsim_125

! SUITABLE V3 parameters:
!   c_D:    0.449908840992091D0
!   c_E:   -0.297207525789026D0
...
subroutine chp_preset_N2LOsim_125
    ...
    call chp_set_c1(  -0.664199701324728D0)
    call chp_set_c3(  -4.233637996890870D0)
    call chp_set_c4(   1.973573952844730D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.150005542940671D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.160531626747336D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.150718059764042D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.160531626747336D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.150778469726602D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.160531626747336D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.487604891872970D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.095744113143330D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.070845742485716D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.813158280385330D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.608408836505865D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.287334031827609D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.772457747118765D0) ! C_3P2
