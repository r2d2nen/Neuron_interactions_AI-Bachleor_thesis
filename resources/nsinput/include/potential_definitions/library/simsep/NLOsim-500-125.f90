...
!   CMD: ./make_chp_init_code NLOsim-500-125.ini +potential_name=NLOsim_125
...
subroutine chp_preset_NLOsim_125
    ...
    call chp_set_CIB_LO_contact(1, -1,   -0.147949191254576D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.170687303257414D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149928862945457D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.170687303257414D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149113059047015D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.170687303257414D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    1.749485536797110D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.299951910599890D0) ! C_3P0
    call chp_set_NLO_contact(3,    1.154116837214520D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.346294331080850D0) ! C_3P1
    call chp_set_NLO_contact(5,   -0.287008201001468D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.132648097978361D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.227523507076321D0) ! C_3P2
