...
!   CMD: ./make_chp_init_code NLOsep-500-290-pp.ini +potential_name=NLOsep_500_290_pp

subroutine chp_preset_NLOsep_500_290_pp
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.812823544522741D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,    0.685064312359464D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.810207928417457D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,    0.685064312359464D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.812719908292250D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,    0.685064312359464D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,   -2.100666575241480D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.306459585001410D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.869155507594867D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.337752665687123D0) ! C_3P1
    call chp_set_NLO_contact(5,   -3.891204586005350D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.312379309832185D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.201271852896283D0) ! C_3P2
