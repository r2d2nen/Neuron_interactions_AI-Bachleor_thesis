...
!   CMD: ./make_chp_init_code LOsim-450-191.ini +potential_name=LOsim_191
...
subroutine chp_preset_LOsim_191
    ...
    call chp_set_LO_contact(1,   -0.112157290851971D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.090342087807086D0) ! Ct_3S1
