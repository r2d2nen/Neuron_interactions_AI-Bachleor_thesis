...
!   CMD: ./make_chp_init_code N2LOsim-450-224.ini +potential_name=N2LOsim_224

! SUITABLE V3 parameters:
!   c_D:   -0.431600230263858D0
!   c_E:   -0.443361845551862D0
...
subroutine chp_preset_N2LOsim_224
    ...
    call chp_set_c1(  -0.210603173944888D0)
    call chp_set_c3(  -3.573809986248610D0)
    call chp_set_c4(   3.836818813557360D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.149300341930538D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.180086468215308D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.150077895785472D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.180086468215308D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149794497402217D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.180086468215308D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.511010348422130D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.163526645279800D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.550761933593260D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.960254851760426D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.721703015373014D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.600252853263371D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.662724132321230D0) ! C_3P2
