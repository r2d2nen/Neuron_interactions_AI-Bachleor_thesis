...
!   CMD: ./make_chp_init_code NLOsep-500-290-pm.ini +potential_name=NLOsep_500_290_pm

subroutine chp_preset_NLOsep_500_290_pm
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.812440874198446D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.174513064911529D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.809884218414025D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.174513064911529D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.812339068950654D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.174513064911529D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,   -2.099930965837500D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.307113549741190D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.849851273678222D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.339891424463816D0) ! C_3P1
    call chp_set_NLO_contact(5,   -0.404010810711899D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.239496736729022D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.201580238749704D0) ! C_3P2
