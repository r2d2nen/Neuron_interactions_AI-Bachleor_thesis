...
!   CMD: ./make_chp_init_code NLOsim-600-125.ini +potential_name=NLOsim_125
...
subroutine chp_preset_NLOsim_125
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.249183880833804D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.096861132325297D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.237151942804548D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.096861132325297D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.242999728976735D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.096861132325297D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.805259897120920D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.470783173991980D0) ! C_3P0
    call chp_set_NLO_contact(3,    1.755557258044310D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.344516170577670D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.035389142207511D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.174355996754679D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.176590194164204D0) ! C_3P2
