...
!   CMD: ./make_chp_init_code LOsim-450-224.ini +potential_name=LOsim_224
...
subroutine chp_preset_LOsim_224
    ...
    call chp_set_LO_contact(1,   -0.112157727587304D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.090342057068679D0) ! Ct_3S1
