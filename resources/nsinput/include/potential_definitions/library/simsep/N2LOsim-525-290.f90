...
!   CMD: ./make_chp_init_code N2LOsim-525-290.ini +potential_name=N2LOsim_290

! SUITABLE V3 parameters:
!   c_D:   -0.166427491925854D0
!   c_E:   -0.566022913689453D0
...
subroutine chp_preset_N2LOsim_290
    ...
    call chp_set_c1(   0.278375303487757D0)
    call chp_set_c3(  -3.575482314757680D0)
    call chp_set_c4(   3.781084716052260D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.145857771997852D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.163934408927348D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.146721697567687D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.163934408927348D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.146563613664227D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.163934408927348D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.545074813929810D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.171225218416850D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.474621875234778D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.930127236639818D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.681094250186346D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.571451187367563D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.660726880299208D0) ! C_3P2
