...
!   CMD: ./make_chp_init_code NLOsim-600-224.ini +potential_name=NLOsim_224
...
subroutine chp_preset_NLOsim_224
    ...
    call chp_set_CIB_LO_contact(1, -1,    0.141802585698872D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.082508125165655D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,    0.132173379900407D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.082508125165655D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,    0.136834426093602D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.082508125165655D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.583703809332210D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.501854064545700D0) ! C_3P0
    call chp_set_NLO_contact(3,    1.597870392702760D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.302451111229858D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.320821342144327D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.411668334371466D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.156144583099001D0) ! C_3P2
