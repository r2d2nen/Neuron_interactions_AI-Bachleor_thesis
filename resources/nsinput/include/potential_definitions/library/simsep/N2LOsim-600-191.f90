...
!   CMD: ./make_chp_init_code N2LOsim-600-191.ini +potential_name=N2LOsim_191

! SUITABLE V3 parameters:
!   c_D:    0.591713474669183D0
!   c_E:   -1.642684114978280D0
...
subroutine chp_preset_N2LOsim_191
    ...
    call chp_set_c1(  -0.275392245391146D0)
    call chp_set_c3(  -3.645363968571930D0)
    call chp_set_c4(   2.691668931118580D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.147436713416621D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.149975578033439D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148313009128329D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.149975578033439D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.148596768066713D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.149975578033439D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.436867279689390D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.541129328202750D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.296100205539297D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.683407827932508D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.526797957270543D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.398896735972944D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.670809067853656D0) ! C_3P2
