...
!   CMD: ./make_chp_init_code N2LOsim-525-257.ini +potential_name=N2LOsim_257

! SUITABLE V3 parameters:
!   c_D:   -0.111004764683157D0
!   c_E:   -0.542801163822173D0
...
subroutine chp_preset_N2LOsim_257
    ...
    call chp_set_c1(   0.103423317060169D0)
    call chp_set_c3(  -3.567796300737880D0)
    call chp_set_c4(   3.588626714195800D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.146812015611716D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.164761300652910D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.147655706331691D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.164761300652910D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.147525758066873D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.164761300652910D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.517144765589540D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.182052961997060D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.450521863513404D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.906201747175974D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.655413346105928D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.547879447852346D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.658981977402445D0) ! C_3P2
