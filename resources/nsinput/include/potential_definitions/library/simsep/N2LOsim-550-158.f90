...
!   CMD: ./make_chp_init_code N2LOsim-550-158.ini +potential_name=N2LOsim_158

! SUITABLE V3 parameters:
!   c_D:    0.334485105199507D0
!   c_E:   -0.645891752377462D0
...
subroutine chp_preset_N2LOsim_158
    ...
    call chp_set_c1(  -0.390614400977574D0)
    call chp_set_c3(  -3.691815373308850D0)
    call chp_set_c4(   2.597894670116720D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.148769322332840D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.156788135985569D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.149539709604638D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.156788135985569D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149667523363258D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.156788135985569D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.433344768105080D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.291533468240480D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.273672397250923D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.795692813135403D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.544440546642133D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.385192956438180D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.682238742770290D0) ! C_3P2
