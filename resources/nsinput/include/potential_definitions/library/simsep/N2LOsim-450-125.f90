...
!   CMD: ./make_chp_init_code N2LOsim-450-125.ini +potential_name=N2LOsim_125

! SUITABLE V3 parameters:
!   c_D:    0.359237959136951D0
!   c_E:   -0.089282214477046D0
...
subroutine chp_preset_N2LOsim_125
    ...
    call chp_set_c1(  -0.832892702345002D0)
    call chp_set_c3(  -4.360065187912000D0)
    call chp_set_c4(   1.899911800607740D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.151163800770492D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.174311410186429D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.151905965381953D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.174311410186429D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.151796496844598D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.174311410186429D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.497861477919400D0) ! C_1S0
    call chp_set_NLO_contact(2,    0.992410575208189D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.063742066882084D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.892817577292435D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.675542076822869D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.313140579168440D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.794132656961655D0) ! C_3P2
