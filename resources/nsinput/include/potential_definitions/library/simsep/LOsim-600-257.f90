...
!   CMD: ./make_chp_init_code LOsim-600-257.ini +potential_name=LOsim_257

subroutine chp_preset_LOsim_257
    ...
    call chp_set_LO_contact(1,   -0.100991161900872D0) ! Ct_1S0
    call chp_set_LO_contact(2,   -0.035637609475991D0) ! Ct_3S1
