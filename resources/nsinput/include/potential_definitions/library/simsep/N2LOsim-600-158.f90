...
!   CMD: ./make_chp_init_code N2LOsim-600-158.ini +potential_name=N2LOsim_158

! SUITABLE V3 parameters:
!   c_D:    0.632397844260683D0
!   c_E:   -1.757417251016160D0
...
subroutine chp_preset_N2LOsim_158
    ...
    call chp_set_c1(  -0.357885273710271D0)
    call chp_set_c3(  -3.629967163583720D0)
    call chp_set_c4(   2.549694121346910D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.147882190320493D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.147716701838644D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.148748219061177D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.147716701838644D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.149064601609215D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.147716701838644D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.418797345413880D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.556165150406360D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.295804326037948D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.653056311785966D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.503732798265753D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.367728150432215D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.669453997517516D0) ! C_3P2
