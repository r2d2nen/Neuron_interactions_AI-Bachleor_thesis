...
!   CMD: ./make_chp_init_code N2LOsim-475-191.ini +potential_name=N2LOsim_191

! SUITABLE V3 parameters:
!   c_D:   -0.002900383050350D0
!   c_E:   -0.304298844303009D0
...
subroutine chp_preset_N2LOsim_191
    ...
    call chp_set_c1(  -0.424100711183227D0)
    call chp_set_c3(  -3.795470507250730D0)
    call chp_set_c4(   2.849939002556590D0)

    call chp_set_CIB_LO_contact(1, -1,   -0.149563584769376D0) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1,   -0.172686161343922D0) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0,   -0.150295932205041D0) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0,   -0.172686161343922D0) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1,   -0.150165201740207D0) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1,   -0.172686161343922D0) ! Ct_3S1nn

    call chp_set_NLO_contact(1,    2.470026527049210D0) ! C_1S0
    call chp_set_NLO_contact(2,    1.129730672352320D0) ! C_3P0
    call chp_set_NLO_contact(3,    0.317527019866827D0) ! C_1P1
    call chp_set_NLO_contact(4,   -0.925031733273488D0) ! C_3P1
    call chp_set_NLO_contact(5,    0.643722176534875D0) ! C_3S1
    call chp_set_NLO_contact(6,    0.454569749794982D0) ! C_3S1-3D1
    call chp_set_NLO_contact(7,   -0.703418465373209D0) ! C_3P2
